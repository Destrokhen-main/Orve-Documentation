...
export default function() {
  return {
    ...
    child: [
      ...
      "<p>Orve старается пока только предложить свой подход. Есть вероятность, что от него в будущем придётся отказаться. Но пока он есть</p>",
      {
        tag: TitleText,
      ...
      "<p>Остаётся понять, как использовать этот объект в вашей ветке</p>",
